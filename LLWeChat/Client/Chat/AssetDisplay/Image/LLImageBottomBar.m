...
//    downloadingMessageIds = [NSMutableArray array];
//    downloadFailedMessageIds = [NSMutableArray array];
}
...
- (void)setDownloadProgress:(NSInteger)progress {
    NSString *str = progress >= 100 ? @"已完成" : [NSString stringWithFormat:@"%ld%%", progress];
