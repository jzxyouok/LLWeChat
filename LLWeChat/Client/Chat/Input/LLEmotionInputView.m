...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [self setupView];
        self.backgroundColor = UIColorRGB(242, 244, 247);
...
- (void)gotoSection:(UIButton *)button {
    ...
    [self.collectionView scrollRectToVisible:CGRectMake(SCREEN_WIDTH * sectionData.startSection, 0, SCREEN_WIDTH, TOP_AREA_HEIGHT) animated:YES];
