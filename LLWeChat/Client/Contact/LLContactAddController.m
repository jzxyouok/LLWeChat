...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [self.navigationController setNavigationBarHidden:self.navigationController.navigationBar.hidden animated:NO];
}

- (void)viewDidAppear:(BOOL)animated {
    [super viewDidAppear:animated];
    
    [self performSelectorOnMainThread:@selector(showNavigationBarAnimated) withObject:nil waitUntilDone:nil];
