...
- (void)searchContactByChatIdOrPhoneNumber:(NSString *)chatId {
    ...
    NSArray<LLUserModel *> *userlist = [[LLContactManager sharedManager] getContactsFromDB];
    for (LLUserModel *userModel in userlist) {
    ...
    LLError *error = [[LLContactManager sharedManager] addContact:buddyName];
