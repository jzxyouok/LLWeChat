...
@property (nonatomic) LLPictureNumberView *numberView;
...
//        self.toolBar.barStyle = UIBarStyleBlack;
    ...
    [_doneBtn setTitleColor:[UIColor colorWithRed:26/255.0 green:175/255.0 blue:10/255.0 alpha:1] forState:UIControlStateNormal];
    ...
    _numberView = [[LLPictureNumberView alloc] initWithFrame:CGRectMake(CGRectGetMinX(_doneBtn.frame)- 27 + 7, (44 - 28)/2, 27, 28)];
