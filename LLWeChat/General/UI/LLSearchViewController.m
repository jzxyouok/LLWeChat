...
//    [_cancelButton setTitleColor:kLLTextColor_green forState:UIControlStateNormal];
//    [_cancelButton addTarget:self action:@selector(cancelTapped:) forControlEvents:UIControlEventTouchUpInside];
//    [_cancelButton sizeToFit];
//    [self.toNavigationBarView addSubview:_cancelButton];
...
//    frame.origin.x = SCREEN_WIDTH + 4;
//    frame.origin.y = _searchBar.frame.origin.y + (CGRectGetHeight(_searchBar.frame) - CGRectGetHeight(frame))/2;
//    _cancelButton.frame = frame;

//    frame = _cancelButton.frame;
//    frame.origin.x = SCREEN_WIDTH - 8 - CGRectGetWidth(frame);
//    _cancelButton.frame = frame;
//    
//    frame = fromSearchBar.frame;
//    frame.origin.x = 0;
//    frame.origin.y = CGRectGetHeight(self.toNavigationBarView.frame) - CGRectGetHeight(fromSearchBar.frame);
//    frame.size.width = CGRectGetMinX(_cancelButton.frame) - 2;
//    self.searchBar.frame = frame;
//    self.searchBar.placeholder = fromSearchBar.placeholder;
//    
//    frame = _cancelButton.frame;
